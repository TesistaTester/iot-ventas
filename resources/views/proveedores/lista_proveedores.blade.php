...
<div class="col-md-10 content-pane">
    <h3 class="title-header" style="text-transform: uppercase;">
        ...
        {{$titulo}}
        <a href="{{secure_url('proveedores/nuevo')}}" class="btn btn-sm btn-success float-right" style="margin-left:10px;"><i class="fa fa-plus"></i> NUEVO proveedor</a>
    </h3>
    <div class="row">
        <div class="col-12">              
                <!-- inicio card  -->
                                ...
                                <td>
                                    <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="{{secure_url('proveedores/'.Crypt::encryptString($item->pve_id).'/editar')}}"><i class="fa fa-edit"></i> Editar</a>
